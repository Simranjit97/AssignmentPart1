...
$conn = new PDO('mysql:host=aws.computerstudi.es;dbname=gc200347471','gc200347471', 'HBRod1plmi');
...
/*Prepare, Execute, and Fetch the results and store them in a variable named $users */
$users = $dbh->query( $sql );
    ...
    <table class="table table-striped table-hover">
        ...
        <?php foreach ( $users as $user ): ?>
            <tr>
                ...
                <td>
                    <form method="post" action="delete-user.php?user_id=<?= $user['id'] ?>">
